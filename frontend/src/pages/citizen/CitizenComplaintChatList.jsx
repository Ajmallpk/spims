...
// ── Page component ─────────────────────────────────────────────────────────
const CitizenComplaintChatList = () => {
  ...
  const handleCardClick = (complaintId) => {
    navigate(`/citizen/messages/${complaintId}`);
  };
  ...
  const filtered = useMemo(() => {
    ...
    return chats.filter((chat) => {
      ...
      const matchesQuery =
        ...
        chat.authority.toLowerCase().includes(q);
      ...
      <div className="max-w-2xl mx-auto px-4 pt-8 pb-16">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Conversations regarding your complaints
          </p>
        </div>
...
export default CitizenComplaintChatList;