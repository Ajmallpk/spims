...
// import { submitVerification } from "@/PanchayathSlice";
import InputField from '@/components/panjayath/InputField'


export default function PanchayathProfile() {
  const dispatch = useDispatch();
  const { profile, verificationStatus, isVerified } = useSelector(
    (state) => state.panchayath
  );
  ...
  const handleSubmitVerification = () => dispatch(submitVerification());
              ...
              {verificationStatus === "APPROVED" && (
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-[0.9rem] leading-[1.75]" style={{ color: status.color }}>
                    ...
                    all Panchayath Authority dashboard features.
                  </p>
                </div>
              )}
            </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-[0.9rem] leading-[1.75] text-white/80 max-w-lg">
                  ...
                  You now have unrestricted access to all Panchayath Authority
                  governance features.
                </p>
              </div>
            </div>
