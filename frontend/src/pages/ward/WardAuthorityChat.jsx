...
const WardAuthorityChat = () => {
    ...
    //     console.log("SOCKET EVENT:", response);
    ...
    //       console.log(
    //         `${data.user} online: ${data.is_online}`
    //       );
    ...
    //               ...msg,
    //               is_deleted: true,
    //               display_message: "This message was deleted",
    //             }
    //             : msg
    //         )
    //       );
        ...
        `}
            >
                <ChatSidebar
                    ...
                    title="SPIMS Chat"
                    subtitle="Ward ↔ Panchayath Communication"

                    searchPlaceholder="Search panchayath chats..."

                    sectionTitle="PANCHAYATH"

                    currentRoleLabel="Ward Authority"
                />
            </div>
            ...
            <div className="flex-1 flex flex-col min-w-0 h-full bg-slate-50">
                {!selectedContact ? (
                    <>
                        ...
                        <EmptyChatState
                            title="Ward Authority Chat"
                            description="Select your panchayath chat to begin secure communication"
                        />
                    </>
                ) : (
                    <>
...
export default WardAuthorityChat;