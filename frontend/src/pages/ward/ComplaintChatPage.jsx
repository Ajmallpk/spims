...
const ComplaintChatPage = () => {
    ...
    const loadComplaintInfo = async () => {
        ...
        try {
            ...
            const res =
                await wardapi.getComplaintDetail(
                    complaintId
                );
    ...
    const handleBack = () => navigate("/ward/complaint-chats");
    const handleViewComplaint = () =>
        navigate(`/ward/complaints/${complaintId}`);
    ...
    const handleCloseChat = async () => {
        ...
        try {
            ...
            await complaintchatapi.toggleChat(
                complaintId
            );
    ...
    return (
        <>
        <PageTitle title="Complaint Chat" />
        <div className="flex flex-col h-[calc(100vh-120px)] bg-slate-50 rounded-xl overflow-hidden">
            ...
            {isClosed ? (
                <ComplaintChatClosedState onReopen={handleReopenChat} />
            ) : (
                <ComplaintChatInput
                    onSend={handleSend}
                    replyTo={replyTo}
