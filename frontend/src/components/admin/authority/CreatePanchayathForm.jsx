...
import { useEffect, useState } from "react";
import { toast } from "react-hot-toast";
import { Mail, Phone, MapPin, Building2, UserCircle, Loader2 } from "lucide-react";
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-emerald-500 px-6 py-5">
        ...
        <p className="text-emerald-50 text-sm mt-1">
          Register a new panchayath authority and its office details
        </p>
      </div>
      ...
      >
        ...
        <div>
          ...
          <FieldLabel icon={MapPin}>District</FieldLabel>
        ...
        <div>
          ...
          <FieldLabel icon={MapPin}>Panchayath</FieldLabel>
