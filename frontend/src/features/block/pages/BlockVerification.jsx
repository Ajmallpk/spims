...
// ─── Status Banner ────────────────────────────────────────────────────────────
function StatusBanner({ icon, bg, borderColor, color, eyebrow, heading, body }) {
  return (
    <div
...
// ─── BlockVerification ────────────────────────────────────────────────────────
export default function BlockVerification() {
  const dispatch = useDispatch();
  const { verificationStatus } = useSelector((state) => state.block);
            ...
            {verificationStatus === "APPROVED" && (
              <>
                <StatusBanner
                  ...
                  body="Your identity has been confirmed and your account is fully active. You have unrestricted access to all Block Authority governance features."
                  icon={
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-[0.9rem] leading-[1.75] text-white/80 max-w-lg">
                      Your verification is on record. All Block Authority
              ...
              <StatusBanner
                ...
                icon={
                  <div className="relative flex items-center justify-center w-full h-full">
                    <span style={{ width:10, height:10, borderRadius:"50%", background:"#d97706", animation:"pulse 2s infinite", display:"block" }} />
                  </div>
                }
              />
            )}
